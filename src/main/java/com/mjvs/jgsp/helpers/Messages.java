...
public class Messages
{
    ...
    public static String AlreadyContains(String object1, Long id1, String object2)
    {
        return String.format("%s with id %d already contains %s", object1, id1, object2);
    }
    ...
    {
        return String.format("%s with id %d doesn`t contain %s with id %d", object1, id1, object2, id2);
    }

    public static String DoesNotContain(String object1, Long id1, String object2)
    {
        return String.format("%s with id %d doesn`t contain %s", object1, id1, object2);
    }
